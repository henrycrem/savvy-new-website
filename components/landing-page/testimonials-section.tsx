...
//       text: "Working with Savvy Group for our restaurant setup was the best decision we made. Their expertise in kitchen layout, menu development, and operational efficiency has helped us become one of the most popular dining spots in Monrovia.",
//       client: {
//         name: "Sarah Williams",
...
//       text: "Our lounge has become the talk of the town thanks to Savvy Group's exceptional design and operational guidance. Their understanding of ambiance, customer flow, and beverage service has helped us create a unique experience for our patrons.",
//       client: {
//         name: "Jennifer Adams",
...
//                       <div className="absolute inset-0 bg-blue-900 items-center justify-center hidden">
//                         \
//                         {testimonials[currentSlide].client.serviceIcon &&
//                           <testimonials[currentSlide].client.serviceIcon size={16} className="text-yellow-500" />}
//                       </div>
//                     </div>
//                     <div className="absolute -bottom-1 -right-1 w-6 h-6 bg-yellow-500 rounded-full flex items-center justify-center shadow-lg">
//                       \
//                       {testimonials[currentSlide].client.serviceIcon &&
//                         <testimonials[currentSlide].client.serviceIcon size={12} className="text-blue-900" />}
//                     </div>
//                   </div>
//                   <div className="ml-3">
