...
const ProjectCard: React.FC<ProjectCardProps> = ({
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className={`flex flex-col lg:flex-row items-center gap-6 sm:gap-8 lg:gap-12 mb-16 sm:mb-20  ${
    ...
    >
      ...
      {/* Content Section */}
      <div className="w-full flex-1 text-gray-800 px-4 sm:px-0">
        <motion.h3
          initial={{ opacity: 0, x: reverse ? 50 : -50 }}
          whileInView={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.6, delay: 0.2 }}
          viewport={{ once: true }}
          className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold mb-4 sm:mb-6 text-blue-900"
        >
          {title}
        </motion.h3>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <span className="text-gray-600 text-sm sm:text-base">Location : {location}</span>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-gray-600 text-sm sm:text-base">Total Area : {area}</span>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-gray-600 text-sm sm:text-base">Duration : {duration}</span>
          </div>
        </motion.div>
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 sm:px-6 py-12 sm:py-16">
          ...
          >
            ...
            <div className="flex items-center justify-center gap-3 mb-6">
              ...
              <span className="text-orange-500 font-medium text-sm sm:text-base">Recent Projects</span>
            </div>
            
            {/* Main Title */}
            <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-7xl font-bold text-blue-900 mb-4 px-4">
            ...
            <motion.p
              ...
              animate={{ opacity: 1 }}
              transition={{ duration: 0.6, delay: 0.3 }}
              className="text-gray-600 text-base sm:text-xl max-w-3xl mx-auto leading-relaxed px-4"
            >
      ...
      <div className="container mx-auto px-4 sm:px-6 py-12 sm:py-20">
        ...
        <motion.div
          ...
          transition={{ duration: 0.6 }}
          viewport={{ once: true }}
          className="mt-16 sm:mt-20 bg-white rounded-3xl p-6 sm:p-12 shadow-lg max-w-7xl mx-auto"
        >
          <div className="text-center mb-8 sm:mb-12">
            <h3 className="text-2xl sm:text-3xl font-bold text-blue-900 mb-4">Project Features</h3>
            <p className="text-gray-600 text-base sm:text-lg">Advanced security infrastructure designed for modern policing</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                whileHover={{ y: -5 }}
                className="text-center p-4 sm:p-6 rounded-xl border border-gray-200 hover:border-orange-200 hover:shadow-lg transition-all duration-300"
              >
                <div className="w-12 h-12 sm:w-16 sm:h-16 bg-orange-500 rounded-full flex items-center justify-center mx-auto mb-4 text-white">
                  {feature.icon}
                </div>
                <h4 className="text-blue-900 font-semibold text-base sm:text-lg mb-2">{feature.title}</h4>
        ...
        >
          <div className="space-y-4 mb-8">
            <h3 className="text-2xl sm:text-3xl font-bold text-blue-900">Ready to Start Your Project?</h3>
            <p className="text-gray-600 text-base sm:text-lg">Let's build something amazing together</p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="border-2 border-blue-900 hover:bg-blue-900 hover:text-white text-blue-900 font-semibold px-6 sm:px-8 py-3 sm:py-4 rounded-full text-base sm:text-lg transition-all duration-300"
            >
